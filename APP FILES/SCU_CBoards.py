        ...
        if batch:
            if not packets_ok or not batch_writer.pages:
                QMessageBox.critical(
                    ...
                    "Click Select Forms Folder and choose ClinicForms:\n"
                    "Right-click SCU Clipboard Builder → Show Package Contents → "
                    "Contents → Resources → ClinicForms.\n\n"
            ...
            QMessageBox.information(
                ...
                f"{batch_path}\n\n"
                "Wait until Finder shows that file size before opening. "
                "If Preview still complains, open the file in Chrome.",
            )
        else:
